...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (!empty($row['user_name'])) {
		$_SESSION['failure'] = 'Gebruikersnaam bestaat al';
	...
	if ($stat) {
		$_SESSION['success'] = 'Admin-gebruiker is succesvol bijgewerkt';
	} else {
		$_SESSION['failure'] = 'Kan Admin-gebruiker niet updaten: ' . $db->getLastError();
	}
...
<div id="page-wrapper">
	<div class="row">
		<div class="col-lg-12">
			<h2 class="page-header"><?php echo (!$edit) ? 'Voeg' : 'Update'; ?> Gebruiker</h2>
		</div>
	</div>
