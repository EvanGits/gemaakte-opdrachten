...
-- Database: `cinema7`
--
CREATE DATABASE IF NOT EXISTS `cinema7` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `cinema7`;
...
CREATE TABLE `films` (
  ...
  `Beschrijving` text CHARACTER SET latin1 DEFAULT NULL,
...
--
-- Tabelstructuur voor tabel `reserveringen_vertoningen`
--

CREATE TABLE `reserveringen_vertoningen` (
  `ReserveringsID` int(11) NOT NULL,
...
--
-- Gegevens worden geëxporteerd voor tabel `vertoningen`
--
...
--
-- AUTO_INCREMENT voor een tabel `vertoningen`
--
ALTER TABLE `vertoningen`
